...
const verifyHostListingInput = ({ title, description, price, type }) => {
    if (title.length > 100) {
...
exports.listingResolvers = {
    Query: {
        listing: (_, { id }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
        ...
        listings: (_, { location, filter, limit, page }, { db }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const query = {};
                const data = {
                    region: null,
    ...
    Mutation: {
        hostListing: (_, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            verifyHostListingInput(input);
            let viewer = yield utils_1.authorize(db, req);
            if (!viewer) {
                throw new Error("viewer cannot be found");
            }
            const { country, city, admin } = yield api_1.Google.geocode(input.address);
