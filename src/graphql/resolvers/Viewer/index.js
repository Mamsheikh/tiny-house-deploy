...
exports.viewerResolvers = {
    ...
    Mutation: {
        logIn: (_, { input }, { db, req, res }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
        ...
        disconnectStripe: (_, _args, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                let viewer = yield utils_1.authorize(db, req);
                if (!viewer) {
                    throw new Error("viewer cannot be found");
                }
                const updateRes = yield db.users.findOneAndUpdate({ _id: viewer._id }, { $set: { walletId: undefined } });
                if (!updateRes.value) {
                    throw new Error("viewer could not be updated");
                }
                viewer = updateRes.value;
                ...
                throw new Error(`failed to disconnect stripe: ${error}`);
            }
        })
    },
    Viewer: {
